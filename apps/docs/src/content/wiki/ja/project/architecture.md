...
TUI は最初のクライアントであって、アーキテクチャの境界ではありません。長期的な境界はローカル音声エンジン、永続セッション、安定イベント契約です（[ロードマップ](/baribari/wiki/ja/project/roadmap)）。
...
![話者別の確定字幕と翻訳を表示するブラウザ共有画面](/baribari/screenshots/web-share.png)
...
- 真のトークンストリーミング ASR・内蔵 TTS 同通・ライブ専用フル diarization は現状対象外（[ロードマップ](/baribari/wiki/ja/project/roadmap)）。
