---
title: "話者"
description: "2 つの問題 問題 仕組み 誰 が話したか 話者 識別 （埋め込み照合） いつ 交代したか VAD 無音区切り +（将来）diarization / 変化点 baribari は各 VAD 区間に 1 つの話者 ID を付けます。区間内の重なり分離はライブ経路の対象外です。 埋め込みモデル モデル "
