---
title: "Models & AI"
description: "Local ASR models, speaker engines, and optional AI."
...
Matching uses the selected embedding model and that model’s cosine threshold (defaults **0.55** CAM++ / **0.45** ERes2Net-large). Voiceprints are **per model**. Details: [Speakers](/baribari/wiki/use/speakers).
