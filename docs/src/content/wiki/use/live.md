...
![Live transcription with speaker labels](/baribari/screenshots/live-transcription.png)
...
See [Configuration](/baribari/wiki/configure/configuration) and [Models & AI](/baribari/wiki/configure/models-ai).
...
Full list: [CLI reference](/baribari/wiki/reference/cli).
